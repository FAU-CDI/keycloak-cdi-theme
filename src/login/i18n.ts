    ...
    .withCustomTranslations({
        en: {
            ...
            cdiOauthGrantIntroText:
                "has requested access to the following data. Before sending any data to the application, you need to confirm it.",
            cdiOauthGrantTitle: "Grant {0} access",
            cdiOauthGrantAccept: "Accept",
            cdiOauthGrantDeny: "Deny",
            cdiOauthGrantInformation: "Legal info",
            cdiOauthGrantRequest: "Do you want to share this data?",
        ...
        de: {
            ...
            cdiOauthGrantIntroText:
                "hat Zugriff auf die folgenden Angaben angefordert. Bevor Daten an die Anwendung gesendet werden, müssen Sie dies bestätigen.",
            cdiOauthGrantTitle: "{0} Zugriff gewähren",
            cdiOauthGrantAccept: "Zustimmen",
            cdiOauthGrantDeny: "Ablehnen",
            cdiOauthGrantInformation: "Rechtliches",
            cdiOauthGrantRequest: "Wollen Sie diese Daten freigeben?",
